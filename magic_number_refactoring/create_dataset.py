...
def _put_files_in_right_bucket(pos_source_file_list, solution, positive_cases_folder, negative_cases_folder,
                               smell_type, code_split_out_folder_class):
    ...
    base_folder_path = os.path.join(code_split_out_folder_class, solution)
...
def scan_solution(solution, positive_cases_folder, negative_cases_folder,
    ...
    total_copied_files = _put_files_in_right_bucket(pos_source_file_list, solution, positive_cases_folder,
                                                    negative_cases_folder,
                                                    smell_type, code_split_out_folder_class)
    # Sanity check
